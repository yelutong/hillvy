export default {
  install(Vue, options) {
    //判断当前展示PC or H5
    Vue.prototype.showIndex = 'PC';//默认展示PC
    Vue.prototype.getShowIndex = function () {
      return Vue.prototype.showIndex
    };
    Vue.prototype.setShowIndex = function (info) { // info 可以传对象
      Vue.prototype.showIndex = info
    };
   ...
   */
    Vue.prototype.addDot = function (str){
        let newStr = "";
        let count = 0;
        // 当数字是整数 
        str=""+str;
    ...
    // rem自适应适配设置
    Vue.prototype.setAutoSizePc = function () {
      var deviceWidth = document.documentElement.clientWidth;
      if (deviceWidth > 1025) {
        deviceWidth = 750;
      };
