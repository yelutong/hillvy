    ...
    return (
      <div className="padding20 privacyService">
        ...
        <div className="serviceDetail">
          <p>Perjanjian Layanan Kerjasama ini dibuat pada tanggal [{this.props.contractData.loanDate||'•'}] (selanjutnya disebut “<b>Perjanjian</b>”) oleh dan antara:</p>
        </div>
        <div className="serviceDetail">
          <div className="lessNum">
            ...
            <span className="text">
              ...
              <span style={{'display':'block','marginTop':'0.2em'}}>[<b>nama Pemberi Pinjaman</b>], warga negara [<b>warga negara Pemberi Pinjaman</b>], pemegang kartu tanda pengenal [{this.props.contractData.lenderName||'xxxx'}] dengan No. [{this.props.contractData.lenderIdNum||'xxx'}], beralamat di [xxxx], dalam hal ini bertindak untuk dan atas nama dirinya, selanjutnya disebut <b>Pemberi Pinjaman</b>.</span>
            </span>
          </div>
          <div className="lessNum">
        ...
        <div className="serviceDetail">
          <div>
            <div className="textRight lessLeft lendingAgreement">
              ...
              <span className="secondNum">
                <span className="num">2.</span>
                <span className="text">Pemberi Pinjaman sepakat akan memberikan dana pinjaman kepada Penyelenggara Layanan (“<b>Pinjaman</b>”) sebesar Rp[{this.props.contractData.principal||'xxxx'}] ([xxxx] rupiah) untuk jangka waktu [{this.props.contractData.term?(this.props.contractData.term+'hari'):'xxx'}] yang berlaku efektif sejak Perjanjian ini ditandatangani.
                </span>
              </span>
              <span className="secondNum">
              ...
              <span className="secondNum">
                ...
                <span className="text">Pemberi Pinjaman dengan ini mengenakan bunga kepada Penerima Pinjaman sebesar [xxx] % ([xxx] persen) pertahun  atau sebesar [{this.props.contractData.rate||'xxx'}] perhari dan bunga berlaku efektif sejak Pinjaman tercatat pada Rekening Escrow Penyelenggara Layanan.
                </span>
              </span>
              <span className="secondNum">
        ...
        <div className="serviceDetail">
          <div>
            <div className="textRight lessLeft lendingAgreement">
              <span className="secondNum">
                <span className="num">1.</span>
                <span className="text">Atas setiap persetujuan permohonan pinjaman yang diajukan Penerima Pinjaman, Penyelenggara berhak atas komisi sebesar [{this.props.contractData.serviceRate||'xxx'}] % terhitung dari jumlah pinjaman yang diajukan Penerima Pinjaman. 
                  <span style={{'display':'block'}}>Jika terdapat denda atas keterlambatan, pendapatan denda adalah sebesar ({this.props.contractData.fixedRate||'xx'})% dari pokok pinjaman. Mulai dari hari keempat sejak tanggal keterlambatan, pendapatan denda adalah sebesar ({this.props.contractData.defaultRate||'xx'})% dari jumlah pokok pinjaman dibebankan setiap hari sampai dengan pelunasan penuh pinjaman;</span>
                </span>
              </span>
              <span className="secondNum">
                <span className="num">2.</span>
        ...
        <div className="serviceDetail">
          <div>
            <div className="textRight lessLeft lendingAgreement">
              <span className="secondNum">
                <span className="num">1.</span>
                <span className="text">Perjanjian ini berlaku untuk jangka waktu [{this.props.contractData.term||'xxx'}] hari dan secara efektif berlaku sejak Perjanjian ini ditandatangani.
                </span>
              </span>
              <span className="secondNum">
                <span className="num">2.</span>
        ...
        <div className="serviceDetail">
          <div>
            <div className="textRight lessLeft lendingAgreement">
              <span className="secondNum">
                <span className="num">1.</span>
                <span className="text">Setelah Transaksi antara Pemberi Pinjaman dan Penerima Pinjaman berakhir, Pemberi Pinjaman setuju untuk memberikan komisi kepada Penyelenggara Layanan dengan presentase sebesar [{this.props.contractData.serviceRate||'xxx'}] % dari nominal dana Pinjaman yang diberikan.
                  <span className="lastNum">
                    Jika terdapat denda atas keterlambatan, pendapatan denda adalah sebesar ({this.props.contractData.fixedRate||'xx'})% dari pokok pinjaman. Mulai dari hari keempat sejak tanggal keterlambatan, pendapatan denda adalah sebesar ({this.props.contractData.defaultRate||'xx'})% dari jumlah pokok pinjaman dibebankan setiap hari sampai dengan pelunasan penuh pinjaman;
                  </span>
                </span>
              </span>
              <span className="secondNum">
            ...
            <div className="textRight lessLeft lendingAgreement">
              ...
              <div style={{'marginTop':'1em'}}>
                ...
                <div className="valueKey">
                  ...
                  <div className="right">: [{this.props.contractData.lenderName||'nama PIC'}]</div>
                </div>
                <div className="valueKey">
              ...
              <div style={{'marginTop':'1em'}}>
                ...
                <div className="valueKey">
                  <div className="left">Nama</div>
                  <div className="right">: [{this.props.contractData.borrowerName||'nama PIC'}]</div>
                </div>
                <div className="valueKey">
                  <div className="left">Jabatan</div>
                  <div className="right">: [Jabatan PIC]</div>
                ...
                <div className="valueKey">
                  <div className="left">Telp</div>
                  <div className="right">: [{this.props.contractData.borrowerPhone||'xxx'}]</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bottomEare">
          ...
          <div className="right" style={{'textAlign':'left'}}>
            ...
            <div><b>[{this.props.contractData.borrowerName||'xxxxx'}]</b></div>
          </div>
        </div>
