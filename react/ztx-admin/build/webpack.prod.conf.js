...
var webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      chunks: ['element-ui', 'vue', 'vendor', 'axios', 'jquery', 'app'],
    ...
    new webpack.optimize.CommonsChunkPlugin({
      ...
      chunks: ['vendor'],
      minChunks: function (module, count) {
        return module.resource && ~['vue'].indexOf(getModuleName(module) ) && count >= 1
      }
    }),
    new webpack.optimize.CommonsChunkPlugin({
      name: 'axios',
      chunks: ['vendor'],
      minChunks: function (module, count) {
        return module.resource && ~['axios'].indexOf(getModuleName(module) ) && count >= 1
      }
    }),
    new webpack.optimize.CommonsChunkPlugin({
      name: 'jquery',
      chunks: ['vendor'],
      minChunks: function (module, count) {
        return module.resource && ~['jquery'].indexOf(getModuleName(module) ) && count >= 1
      }
    }),
