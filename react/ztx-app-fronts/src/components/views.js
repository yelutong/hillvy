...
const views = [
	...
	{pathName:'#/HowToRepay',title:'How to repay',IndonesianTitle:'Tata Cara Pembayaran'},//HowToRepay
	...
	{pathName:'#/LoanDetailExplain',title:'Penjelasan Produk',IndonesianTitle:'Penjelasan Produk'},//小额现金贷介绍页
	{pathName:'#/LoanStageDetail',title:'Penjelasan Produk',IndonesianTitle:'Penjelasan Produk'},//现金分期产品介绍页
	{pathName:'#/RepaymentList',title:'Rencana Jadwal Pembayaran',IndonesianTitle:'Rencana Jadwal Pembayaran'},//现金分期产品介绍页
	{pathName:'#/LargeStageAgree',title:'Perjanjian Pemberian Pinjaman',IndonesianTitle:'Perjanjian Pemberian Pinjaman'},//大额借款协议
  {pathName:'#/ApprovalResult',title:'Status Permohonan',IndonesianTitle:'Status Permohonan'},
