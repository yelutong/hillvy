    ...
    return (
      <div className="padding20 privacyService">
        ...
        <div className="serviceDetail">
          <p>Pada hari <b>[•]</b>, tanggal <b>[•]</b> bulan <b>[•]</b> tahun <b>[•] telah ditandatangani</b> Perjanjian Pemberian Pinjaman Pribadi <b>(“Perjanjian”)</b> dibuat oleh:</p>
        </div>
        <div className="serviceDetail">
          <div className="lessNum">
            <span className="num">1)</span>
            <span className="text"><b>[Pemberi Pinjaman:{this.props.contractData.lenderName || 'Pemberi Pinjaman'}]</b>, [Nomor KTP:{this.props.contractData.lenderIdNum||'Nomor KTP'}], [Tanggal lahir:{this.props.contractData.lenderBirth||'Tanggal lahir'}], [Nomor Telepon HP: {this.props.contractData.lenderPhone||'Nomor Telepon HP'}], [Alamat], selanjutnya disebut <b>Kreditur</b>.</span>
          </div>
          <div className="lessNum">
            <span className="num">2)</span>
            <span className="text"><b>[Penerima Pinjaman:{this.props.contractData.borrowerName||'Penerima Pinjaman'}]</b>, [Nomor KTP: {this.props.contractData.borrowerIdNum || 'Nomor KTP'}], [Tanggal lahir: {this.props.contractData.borrowerBirth ||'Tanggal lahir'}], [Nomor Telepon HP: {this.props.contractData.borrowerPhone||'Nomor Telepon HP'}], [Alamat], selanjutnya disebut <b>Debitur</b>.</span>
          </div>
        </div>
        <div className="serviceDetail">
          <p><b>[Pemberi Pinjaman: {this.props.contractData.lenderName||'Pemberi Pinjaman'}] dengan [Penerima Pinjaman: {this.props.contractData.borrowerName || 'Penerima Pinjaman'}]</b> sepakat untuk membuat Perjanjian Pemberian Pinjaman Pribadi (selanjutnya disebut “<b>Perjanjian</b>”) dengan ketentuan dan syarat-syarat sebagai berikut:</p>
        </div>
          ...
          <div>
            <div className="textRight lessLeft threeEara">
              <span className="secondNum">
                ...
                <span className="argument">Rp[{this.props.contractData.principal||'•'}]</span>
              </span>
              <span className="secondNum">
                <span className="num">b.</span>
                <span className="text">Biaya Jasa:</span>
                <span className="argument">Rp[{this.props.contractData.serviceAmt||'•'}]</span>
              </span>
              <span className="secondNum">
                <span className="num">c.</span>
                <span className="text">Jumlah pinjaman yang akan diterima:</span>
                <span className="argument">Rp[{this.props.contractData.loanAmount||'•'}]</span>
              </span>
              <span className="secondNum">
                <span className="num">d.</span>
                <span className="text">Tanggal Efektif Pinjaman:</span>
                <span className="argument">[{this.props.contractData.loanDate||'•'}]</span>
              </span>
              <span className="secondNum">
                <span className="num">e.</span>
                <span className="text">Jangka Waktu Pinjaman:</span>
                <span className="argument">[{this.props.contractData.term?(this.props.contractData.term+'hari'):'•'}]</span>
              </span>
            </div>
          </div>
        </div>
          ...
          <div>
            <div className="textRight lessLeft threeEara">
              <span className="secondNum">
                ...
                <span className="argument">[{this.props.contractData.returnDate||'•'}]</span>
              </span>
              <span className="secondNum">
                <span className="num">b.</span>
                <span className="text">Suku Bunga Pinjaman:</span>
                <span className="argument">[{this.props.contractData.interest||'•'}]</span>
              </span>
              <span className="secondNum">
                <span className="num">c.</span>
              ...
              <span className="secondNum">
                ...
                <span className="argument">[{this.props.contractData.returnAmt||'•'}]</span>
              </span>
            </div>
          </div>
        </div>
            ...
            <div className="textRight lessLeft">
              ...
              <span className="secondNum">
                ...
                <span className="text">Untuk setiap keterlambatan pembayaran pinjaman yang terhutang dan telah jatuh tempo, Debitur dikenakan denda sebagai berikut:
                  <span className="lastNum">
                    <span className="num">1)</span>
                    <span className="text"> Dari Tanggal Keterlambatan akan dikenakan biaya denda keterlambatan, dimana biaya denda adalah sebesar ({this.props.contractData.fixedRate||'xx'})% dari pokok pinjaman.
                      <span style={{'display':'block'}}>Mulai dari hari keempat sejak tanggal keterlambatan, denda adalah sebesar ({this.props.contractData.defaultRate||'xx'})% dari jumlah pokok pinjaman dibebankan setiap hari sampai dengan pelunasan penuh pinjaman;</span>
                    </span>
                  </span>
                  <span className="lastNum">
                    <span className="num">2)</span>
                    <span className="text">Sejak Tanggal Keterlambatan, akan dikenakan denda ({this.props.contractData.rate||'xx'})% dari jumlah pokok pinjaman setiap harinya sampai dengan pelunasan penuh pinjaman; 
                    </span>
                  </span>
                  <span className="lastNum">
                    <span className="num">3)</span>
                    <span className="text">Sejak hari ke {this.props.contractData.overdueCountMaxDay||'81'} dari Tanggal Keterlambatan, tidak ada lagi denda keterlambatan. 
                    </span>
                  </span>
                </span>
              </span>
